...
# kuadrant.io/developer-portal-controller-bundle:$VERSION and kuadrant.io/developer-portal-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= kuadrant.io/developer-portal-controller
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name developer-portal-controller-builder
	$(CONTAINER_TOOL) buildx use developer-portal-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm developer-portal-controller-builder
	rm Dockerfile.cross
